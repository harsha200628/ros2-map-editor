...
This letter presents \emph{ROS2 Map Editor}, a single-page web application that runs entirely inside the browser (no ROS installation, no backend server, no uploaded data leaving the client) and directly addresses the three problems above. Its contributions are:
\begin{enumerate}
