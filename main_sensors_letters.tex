...
\usepackage{textcomp}
% ============================================================
%  2D Occupancy Grid Map Editor -- Standard IEEE Journal Template
...
\title{2D Occupancy Grid Map Editor: A Browser Tool for Semantic Editing, Path Preview, and Map Fusion}

\markboth{Vol.~1, No.~1, September~2026}{0000000}
\IEEELSENSarticlesubject{Robotics and Automation}

\author{\IEEEauthorblockN{GC~Harsha~Vardhan~Reddy\IEEEauthorrefmark{1}}%
\IEEEauthorblockA{\IEEEauthorrefmark{1}Department of Electrical, Electronics and Communication Engineering (EECE), GITAM Deemed to be University, Bengaluru, India}%
\thanks{Corresponding author: GC Harsha Vardhan Reddy (e-mail: harshavardhanh426@gmail.com).}%
}
...
This paper presents \emph{2D Occupancy Grid Map Editor}, a single-page web application that runs entirely inside the browser (no ROS installation, no backend server, no uploaded data leaving the client) and directly addresses the three problems above. Its contributions are:
\begin{enumerate}
