...
\author{GC~Harsha~Vardhan~Reddy% <-this % stops a space
\thanks{GC Harsha Vardhan Reddy is with the Department of Electrical, Electronics and Communication Engineering (EECE), GITAM Deemed to be University, Bengaluru, India (e-mail: harshavardhanh426@gmail.com).}% <-this % stops a space
}

\markboth{Journal of \LaTeX\ Class Files,~Vol.~14, No.~8, August~2026}%
{Reddy: 2D Occupancy Grid Map Editor}
